...
class Performance(Base):
    ...
    base_goals = Column(Integer)
    base_spent = Column(NVARCHAR(12))
    base_cpm = Column(NVARCHAR(12))
    base_cpc = Column(NVARCHAR(12))
    base_cpa = Column(NVARCHAR(12))
    base_ctr = Column(Float)
    base_cr = Column(Integer)
    events_opening_app = Column(Integer)
    events_opening_post = Column(Integer)
    events_moving_into_group = Column(Integer)
    events_clicks_on_external_url = Column(Integer)
    events_launching_video = Column(Integer)
    events_comments = Column(Integer)
    events_joinings = Column(Integer)
    events_likes = Column(Integer)
    events_shares = Column(Integer)
    events_votings = Column(Integer)
    events_sending_form = Column(Integer)
    ...
    video_started_cost = Column(NVARCHAR(12))
    video_viewed_10_seconds_cost = Column(NVARCHAR(12))
    video_viewed_25_percent_cost = Column(NVARCHAR(12))
    video_viewed_50_percent_cost = Column(NVARCHAR(12))
    video_viewed_75_percent_cost = Column(NVARCHAR(12))
    video_viewed_100_percent_cost = Column(NVARCHAR(12))
    carousel_slide_1_clicks = Column(Integer)
    carousel_slide_1_shows = Column(Integer)
    carousel_slide_2_clicks = Column(Integer)
    carousel_slide_2_shows = Column(Integer)
    carousel_slide_3_clicks = Column(Integer)
    carousel_slide_3_shows = Column(Integer)
    carousel_slide_4_clicks = Column(Integer)
    carousel_slide_4_shows = Column(Integer)
    carousel_slide_5_clicks = Column(Integer)
    carousel_slide_5_shows = Column(Integer)
    carousel_slide_6_clicks = Column(Integer)
    carousel_slide_6_shows = Column(Integer)
    carousel_slide_1_ctr = Column(Integer)
    carousel_slide_2_ctr = Column(Integer)
    carousel_slide_3_ctr = Column(Integer)
    carousel_slide_4_ctr = Column(Integer)
    carousel_slide_5_ctr = Column(Integer)
    carousel_slide_6_ctr = Column(Integer)
    ad_offers_offer_postponed = Column(Integer)
    ad_offers_upload_receipt = Column(Integer)
    ad_offers_earn_offer_rewards = Column(Integer)
    playable_playable_game_open = Column(Integer)
    playable_playable_game_close = Column(Integer)
    playable_playable_call_to_action = Column(Integer)
    tps_tps = Column(NVARCHAR(12))
    tps_tpd = Column(NVARCHAR(12))
    ...
    romi_value = Column(NVARCHAR(12))
    romi_romi = Column(Integer)
    romi_adv_cost_share = Column(Integer)
